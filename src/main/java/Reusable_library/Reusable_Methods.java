...
public class Reusable_Methods {
    ...
    //********************************************************************
    //method to click on an element
    public static void clickExplicit(WebDriver driver, String locator, String elementName) {
    ...
    //********************************************************************
    //method to click on an element by index number
    public static void clickByIndexExplicit(WebDriver driver, String locator, int indexNum, String elementName) {
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        try {
            //Thread.sleep(1500);
            System.out.println("Clicking on element " + elementName + " by index number " + indexNum);
    ...
    //method to enter a keyword on an element
    public static void typeExplicit(WebDriver driver, String locator, String userValue, String elementName) {
        //for explicit use WebDriverWait command
        WebDriverWait wait = new WebDriverWait(driver,timeout);
        try {
            //Thread.sleep(1500);
